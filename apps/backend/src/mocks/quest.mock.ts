...
export const mockQuests: Quest[] = [
  {
    ...
    description: "A precious gem was stolen by a band of river raiders. Retrieve it and return it safely.",
  ...
  },
  {
    ...
    description: "The old mine tunnels have been infested by earth elementals. Clear them so miners can return.",
  ...
  },
  {
    ...
    description: "A caravan needs protection through bandit-prone passes. Ensure all wagons reach the next town.",
